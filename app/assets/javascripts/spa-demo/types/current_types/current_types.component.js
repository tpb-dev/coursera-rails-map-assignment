(function() {
  ...
  function CurrentTypesMapController($scope, $q, $element, 
                                        currentOrigin, myLocation, Map, currentTypes, 
                                        APP_CONFIG) {
    var vm=this;

    vm.$onInit = function() {
      console.log("CurrentTypesMapController",$scope);
    }
    vm.$postLink = function() {
      ...
      $scope.$watch(
        function(){ return currentTypes.getCurrentImage(); }, 
        function(link) { 
          if (link) { 
