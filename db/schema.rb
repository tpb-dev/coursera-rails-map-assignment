...
ActiveRecord::Schema.define(version: 20190410061847) do
  ...
  add_index "trip_images", ["image_id", "trip_id"], name: "index_trip_images_on_image_id_and_trip_id", unique: true, using: :btree
